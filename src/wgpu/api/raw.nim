...
type
  ...
  ProcBindGroupLayoutSetLabel* = proc (bindGroupLayout: BindGroupLayout;
                                    label: cstring) {.cdecl.}
  ...
  ProcBufferMapAsync* = proc (buffer: Buffer; mode: MapModeFlags; offset: csize_t;
  ...
  ProcCommandEncoderBeginComputePass* = proc (commandEncoder: CommandEncoder;
      descriptor: ptr ComputePassDescriptor): ComputePassEncoder {.cdecl.}
  ProcCommandEncoderBeginRenderPass* = proc (commandEncoder: CommandEncoder;
      descriptor: ptr RenderPassDescriptor): RenderPassEncoder {.cdecl.}
  ProcCommandEncoderClearBuffer* = proc (commandEncoder: CommandEncoder;
                                      buffer: Buffer; offset: uint64;
                                      size: uint64) {.cdecl.}
  ProcCommandEncoderCopyBufferToBuffer* = proc (commandEncoder: CommandEncoder;
      source: Buffer; sourceOffset: uint64; destination: Buffer;
      destinationOffset: uint64; size: uint64) {.cdecl.}
  ProcCommandEncoderCopyBufferToTexture* = proc (commandEncoder: CommandEncoder;
      source: ptr ImageCopyBuffer; destination: ptr ImageCopyTexture;
      copySize: ptr Extent3D) {.cdecl.}
  ProcCommandEncoderCopyTextureToBuffer* = proc (commandEncoder: CommandEncoder;
      source: ptr ImageCopyTexture; destination: ptr ImageCopyBuffer;
      copySize: ptr Extent3D) {.cdecl.}
  ProcCommandEncoderCopyTextureToTexture* = proc (commandEncoder: CommandEncoder;
      source: ptr ImageCopyTexture; destination: ptr ImageCopyTexture;
      copySize: ptr Extent3D) {.cdecl.}
  ProcCommandEncoderFinish* = proc (commandEncoder: CommandEncoder;
                                 descriptor: ptr CommandBufferDescriptor): CommandBuffer {.cdecl.}
  ProcCommandEncoderInsertDebugMarker* = proc (commandEncoder: CommandEncoder;
      markerLabel: cstring) {.cdecl.}
  ProcCommandEncoderPopDebugGroup* = proc (commandEncoder: CommandEncoder) {.cdecl.}
  ProcCommandEncoderPushDebugGroup* = proc (commandEncoder: CommandEncoder;
      groupLabel: cstring) {.cdecl.}
  ProcCommandEncoderResolveQuerySet* = proc (commandEncoder: CommandEncoder;
      querySet: QuerySet; firstQuery: uint; queryCount: uint;
      destination: Buffer; destinationOffset: uint64) {.cdecl.}
  ProcCommandEncoderSetLabel* = proc (commandEncoder: CommandEncoder; label: cstring) {.cdecl.}
  ProcCommandEncoderWriteTimestamp* = proc (commandEncoder: CommandEncoder;
      querySet: QuerySet; queryIndex: uint) {.cdecl.}
  ProcComputePassEncoderBeginPipelineStatisticsQuery* = proc (
      computePassEncoder: ComputePassEncoder; querySet: QuerySet;
      queryIndex: uint) {.cdecl.}
  ProcComputePassEncoderDispatchWorkgroups* = proc (
      computePassEncoder: ComputePassEncoder; workgroupCountX: uint;
      workgroupCountY: uint; workgroupCountZ: uint) {.cdecl.}
  ProcComputePassEncoderDispatchWorkgroupsIndirect* = proc (
      computePassEncoder: ComputePassEncoder; indirectBuffer: Buffer;
      indirectOffset: uint64) {.cdecl.}
  ...
  ProcComputePassEncoderEndPipelineStatisticsQuery* = proc (
      computePassEncoder: ComputePassEncoder) {.cdecl.}
  ProcComputePassEncoderInsertDebugMarker* = proc (
      computePassEncoder: ComputePassEncoder; markerLabel: cstring) {.cdecl.}
  ProcComputePassEncoderPopDebugGroup* = proc (
      computePassEncoder: ComputePassEncoder) {.cdecl.}
  ProcComputePassEncoderPushDebugGroup* = proc (
      computePassEncoder: ComputePassEncoder; groupLabel: cstring) {.cdecl.}
  ProcComputePassEncoderSetBindGroup* = proc (
      computePassEncoder: ComputePassEncoder; groupIndex: uint;
      group: BindGroup; dynamicOffsetCount: uint; dynamicOffsets: ptr uint) {.cdecl.}
  ProcComputePassEncoderSetLabel* = proc (computePassEncoder: ComputePassEncoder;
                                       label: cstring) {.cdecl.}
  ProcComputePassEncoderSetPipeline* = proc (
      computePassEncoder: ComputePassEncoder; pipeline: ComputePipeline) {.cdecl.}
  ProcComputePipelineGetBindGroupLayout* = proc (computePipeline: ComputePipeline;
      groupIndex: uint): BindGroupLayout {.cdecl.}
  ProcComputePipelineSetLabel* = proc (computePipeline: ComputePipeline;
                                    label: cstring) {.cdecl.}
  ProcDeviceCreateBindGroup* = proc (device: Device;
                                  descriptor: ptr BindGroupDescriptor): BindGroup {.cdecl.}
  ...
  ProcDeviceCreateCommandEncoder* = proc (device: Device;
                                       descriptor: ptr CommandEncoderDescriptor): CommandEncoder {.cdecl.}
  ProcDeviceCreateComputePipeline* = proc (device: Device; descriptor: ptr ComputePipelineDescriptor): ComputePipeline {.cdecl.}
  ProcDeviceCreateComputePipelineAsync* = proc (device: Device;
      descriptor: ptr ComputePipelineDescriptor;
      callback: CreateComputePipelineAsyncCallback; userdata: pointer) {.cdecl.}
  ProcDeviceCreatePipelineLayout* = proc (device: Device;
                                       descriptor: ptr PipelineLayoutDescriptor): PipelineLayout {.cdecl.}
  ProcDeviceCreateQuerySet* = proc (device: Device;
                                 descriptor: ptr QuerySetDescriptor): QuerySet {.cdecl.}
  ProcDeviceCreateRenderBundleEncoder* = proc (device: Device;
      descriptor: ptr RenderBundleEncoderDescriptor): RenderBundleEncoder {.cdecl.}
  ProcDeviceCreateRenderPipeline* = proc (device: Device;
                                       descriptor: ptr RenderPipelineDescriptor): RenderPipeline {.cdecl.}
  ProcDeviceCreateRenderPipelineAsync* = proc (device: Device;
      descriptor: ptr RenderPipelineDescriptor;
      callback: CreateRenderPipelineAsyncCallback; userdata: pointer) {.cdecl.}
  ProcDeviceCreateSampler* = proc (device: Device; descriptor: ptr SamplerDescriptor): Sampler {.cdecl.}
  ProcDeviceCreateShaderModule* = proc (device: Device;
                                     descriptor: ptr ShaderModuleDescriptor): ShaderModule {.cdecl.}
  ProcDeviceCreateSwapChain* = proc (device: Device; surface: Surface;
  ...
  ProcDeviceSetDeviceLostCallback* = proc (device: Device;
                                        callback: DeviceLostCallback;
                                        userdata: pointer) {.cdecl.}
  ProcDeviceSetLabel* = proc (device: Device; label: cstring) {.cdecl.}
  ProcDeviceSetUncapturedErrorCallback* = proc (device: Device;
      callback: ErrorCallback; userdata: pointer) {.cdecl.}
  ProcInstanceCreateSurface* = proc (instance: Instance;
                                  descriptor: ptr SurfaceDescriptor): Surface {.cdecl.}
  ProcInstanceProcessEvents* = proc (instance: Instance) {.cdecl.}
  ProcInstanceRequestAdapter* = proc (instance: Instance;
  ...
  ProcQueueOnSubmittedWorkDone* = proc (queue: Queue;
                                     callback: QueueWorkDoneCallback;
                                     userdata: pointer) {.cdecl.}
  ProcQueueSetLabel* = proc (queue: Queue; label: cstring) {.cdecl.}
  ProcQueueSubmit* = proc (queue: Queue; commandCount: uint;
                        commands: ptr CommandBuffer) {.cdecl.}
  ProcQueueWriteBuffer* = proc (queue: Queue; buffer: Buffer; bufferOffset: uint64;
                             data: pointer; size: csize_t) {.cdecl.}
  ProcQueueWriteTexture* = proc (queue: Queue; destination: ptr ImageCopyTexture;
                              data: pointer; dataSize: csize_t;
                              dataLayout: ptr TextureDataLayout;
                              writeSize: ptr Extent3D) {.cdecl.}
  ProcRenderBundleEncoderDraw* = proc (renderBundleEncoder: RenderBundleEncoder;
                                    vertexCount: uint;
                                    instanceCount: uint;
                                    firstVertex: uint; firstInstance: uint) {.cdecl.}
  ProcRenderBundleEncoderDrawIndexed* = proc (
      renderBundleEncoder: RenderBundleEncoder; indexCount: uint;
      instanceCount: uint; firstIndex: uint; baseVertex: int32;
      firstInstance: uint) {.cdecl.}
  ...
  ProcRenderBundleEncoderDrawIndirect* = proc (
      renderBundleEncoder: RenderBundleEncoder; indirectBuffer: Buffer;
      indirectOffset: uint64) {.cdecl.}
  ProcRenderBundleEncoderFinish* = proc (renderBundleEncoder: RenderBundleEncoder;
                                      descriptor: ptr RenderBundleDescriptor): RenderBundle {.cdecl.}
  ProcRenderBundleEncoderInsertDebugMarker* = proc (
      renderBundleEncoder: RenderBundleEncoder; markerLabel: cstring) {.cdecl.}
  ProcRenderBundleEncoderPopDebugGroup* = proc (
      renderBundleEncoder: RenderBundleEncoder) {.cdecl.}
  ProcRenderBundleEncoderPushDebugGroup* = proc (
      renderBundleEncoder: RenderBundleEncoder; groupLabel: cstring) {.cdecl.}
  ProcRenderBundleEncoderSetBindGroup* = proc (
      renderBundleEncoder: RenderBundleEncoder; groupIndex: uint;
      group: BindGroup; dynamicOffsetCount: uint; dynamicOffsets: ptr uint) {.cdecl.}
  ProcRenderBundleEncoderSetIndexBuffer* = proc (
      renderBundleEncoder: RenderBundleEncoder; buffer: Buffer; format: IndexFormat;
      offset: uint64; size: uint64) {.cdecl.}
  ProcRenderBundleEncoderSetLabel* = proc (renderBundleEncoder: RenderBundleEncoder;
                                        label: cstring) {.cdecl.}
  ProcRenderBundleEncoderSetPipeline* = proc (
      renderBundleEncoder: RenderBundleEncoder; pipeline: RenderPipeline) {.cdecl.}
  ProcRenderBundleEncoderSetVertexBuffer* = proc (
      renderBundleEncoder: RenderBundleEncoder; slot: uint; buffer: Buffer;
      offset: uint64; size: uint64) {.cdecl.}
  ProcRenderPassEncoderBeginOcclusionQuery* = proc (
      renderPassEncoder: RenderPassEncoder; queryIndex: uint) {.cdecl.}
  ProcRenderPassEncoderBeginPipelineStatisticsQuery* = proc (
      renderPassEncoder: RenderPassEncoder; querySet: QuerySet; queryIndex: uint) {.cdecl.}
  ProcRenderPassEncoderDraw* = proc (renderPassEncoder: RenderPassEncoder;
                                  vertexCount: uint; instanceCount: uint;
                                  firstVertex: uint; firstInstance: uint) {.cdecl.}
  ProcRenderPassEncoderDrawIndexed* = proc (renderPassEncoder: RenderPassEncoder;
      indexCount: uint; instanceCount: uint; firstIndex: uint;
      baseVertex: int32; firstInstance: uint) {.cdecl.}
  ProcRenderPassEncoderDrawIndexedIndirect* = proc (
      renderPassEncoder: RenderPassEncoder; indirectBuffer: Buffer;
      indirectOffset: uint64) {.cdecl.}
  ProcRenderPassEncoderDrawIndirect* = proc (renderPassEncoder: RenderPassEncoder;
      indirectBuffer: Buffer; indirectOffset: uint64) {.cdecl.}
  ProcRenderPassEncoderEnd* = proc (renderPassEncoder: RenderPassEncoder) {.cdecl.}
  ProcRenderPassEncoderEndOcclusionQuery* = proc (
      renderPassEncoder: RenderPassEncoder) {.cdecl.}
  ProcRenderPassEncoderEndPipelineStatisticsQuery* = proc (
      renderPassEncoder: RenderPassEncoder) {.cdecl.}
  ProcRenderPassEncoderExecuteBundles* = proc (
      renderPassEncoder: RenderPassEncoder; bundlesCount: uint;
      bundles: ptr RenderBundle) {.cdecl.}
  ProcRenderPassEncoderInsertDebugMarker* = proc (
      renderPassEncoder: RenderPassEncoder; markerLabel: cstring) {.cdecl.}
  ...
  ProcRenderPassEncoderPushDebugGroup* = proc (
      renderPassEncoder: RenderPassEncoder; groupLabel: cstring) {.cdecl.}
  ProcRenderPassEncoderSetBindGroup* = proc (renderPassEncoder: RenderPassEncoder;
      groupIndex: uint; group: BindGroup; dynamicOffsetCount: uint;
      dynamicOffsets: ptr uint) {.cdecl.}
  ProcRenderPassEncoderSetBlendConstant* = proc (
      renderPassEncoder: RenderPassEncoder; color: ptr Color) {.cdecl.}
  ProcRenderPassEncoderSetIndexBuffer* = proc (
      renderPassEncoder: RenderPassEncoder; buffer: Buffer; format: IndexFormat;
      offset: uint64; size: uint64) {.cdecl.}
  ProcRenderPassEncoderSetLabel* = proc (renderPassEncoder: RenderPassEncoder;
                                      label: cstring) {.cdecl.}
  ProcRenderPassEncoderSetPipeline* = proc (renderPassEncoder: RenderPassEncoder;
      pipeline: RenderPipeline) {.cdecl.}
  ProcRenderPassEncoderSetScissorRect* = proc (
      renderPassEncoder: RenderPassEncoder; x: uint; y: uint; width: uint;
      height: uint) {.cdecl.}
  ProcRenderPassEncoderSetStencilReference* = proc (
      renderPassEncoder: RenderPassEncoder; reference: uint) {.cdecl.}
  ProcRenderPassEncoderSetVertexBuffer* = proc (
      renderPassEncoder: RenderPassEncoder; slot: uint; buffer: Buffer;
      offset: uint64; size: uint64) {.cdecl.}
  ProcRenderPassEncoderSetViewport* = proc (renderPassEncoder: RenderPassEncoder;
      x: cfloat; y: cfloat; width: cfloat; height: cfloat; minDepth: cfloat;
      maxDepth: cfloat) {.cdecl.}
  ProcRenderPipelineGetBindGroupLayout* = proc (renderPipeline: RenderPipeline;
      groupIndex: uint): BindGroupLayout {.cdecl.}
  ...
  ProcShaderModuleGetCompilationInfo* = proc (shaderModule: ShaderModule;
      callback: CompilationInfoCallback; userdata: pointer) {.cdecl.}
  ...
  ProcTextureCreateView* = proc (texture: Texture;
                              descriptor: ptr TextureViewDescriptor): TextureView {.cdecl.}
...
proc createInstance*(descriptor: ptr InstanceDescriptor): Instance {.cdecl, importc: "wgpuCreateInstance".}
...
proc bufferGetSize*(buffer: Buffer): uint64 {.cdecl, importc: "wgpuBufferGetSize".}
proc bufferGetUsage*(buffer: Buffer): BufferUsage {.cdecl, importc: "wgpuBufferGetUsage".}
...
proc bufferSetLabel*(buffer: Buffer; label: cstring) {.cdecl, importc: "wgpuBufferSetLabel".}
...
proc commandEncoderSetLabel*(commandEncoder: CommandEncoder; label: cstring) {.cdecl, importc:"wgpuCommandEncoderSetLabel".}
...
proc computePassEncoderSetLabel*(computePassEncoder: ComputePassEncoder; label: cstring) {.cdecl, importc:"wgpuComputePassEncoderSetLabel".}
...
proc computePipelineSetLabel*(computePipeline: ComputePipeline; label: cstring) {.cdecl, importc:"wgpuComputePipelineSetLabel".}
...
proc querySetGetType*(querySet: QuerySet): QueryType {.cdecl, importc: "wgpuQuerySetGetType".}
...
proc renderBundleEncoderSetLabel*(renderBundleEncoder: RenderBundleEncoder; label: cstring) {.cdecl, importc:"wgpuRenderBundleEncoderSetLabel".}
...
proc renderPipelineSetLabel*(renderPipeline: RenderPipeline; label: cstring) {.cdecl, importc:"wgpuRenderPipelineSetLabel".}
...
proc textureGetDimension*(texture: Texture): TextureDimension {.cdecl, importc: "wgpuTextureGetDimension".}
proc textureGetFormat*(texture: Texture): TextureFormat {.cdecl, importc: "wgpuTextureGetFormat".}
proc textureGetHeight*(texture: Texture): uint {.cdecl, importc: "wgpuTextureGetHeight".}
proc textureGetMipLevelCount*(texture: Texture): uint {.cdecl, importc: "wgpuTextureGetMipLevelCount".}
proc textureGetSampleCount*(texture: Texture): uint {.cdecl, importc: "wgpuTextureGetSampleCount".}
proc textureGetUsage*(texture: Texture): TextureUsage {.cdecl, importc: "wgpuTextureGetUsage".}
proc textureGetWidth*(texture: Texture): uint {.cdecl, importc: "wgpuTextureGetWidth".}
proc textureSetLabel*(texture: Texture; label: cstring) {.cdecl, importc: "wgpuTextureSetLabel".}
proc textureViewSetLabel*(textureView: TextureView; label: cstring) {.cdecl, importc: "wgpuTextureViewSetLabel".}
